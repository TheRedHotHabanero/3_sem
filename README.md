...
## [6_readdir](link)
### Задача 6.1
opendit + readdir + closedir (выводит только имя текущего каталога и чет еще)
### Задача 6.2
Реализовать 6.1 с учетом argv[1]. Open + fdopendir, opendir + dirfd + readdir + fstat + close
### Задача 6.3
Решить 6.2 через open+getdents (6.4)+close. Помним про размер буфера, смысл в ускорении чтения больших каталогов
### Задача 6.4
Научиться читать каталоги. И вывод содержимого + смотри описание 6.3