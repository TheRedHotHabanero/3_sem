...
# [2_open_write_close](/2_open_write_close)
### • [Задача 2.1](/2_open_write_close/2_1.c)
Разобрана на паре. Записать в указанный файл указанное содержимое. Изучаем open, write, close.
### • [Задача 2.2](/2_open_write_close/2_2.c)
...
# [3_copyfiles](/3_copy_files)
### • [Задача 3.1](/3_copy_files/3_1.c)
...
### • [Задача 3*](/3_copy_files/3_extra.c)
...
# [4_metadata_copy](/4_metadara_copy)
### • [Задача 4](/4_metadara_copy/4.c)
...
# [5_extra_fchown](/5_extra_fchown)
### • [Задача 5*](/5_extra_fchown/5.c)
...
# [11_flock](/11_flock)
### • [Задача 11](/11_flock/11.c)
Программа, которая подсчитывает, сколько раз она запускалась.

# [12_process](/12_process)
### • [Задача 12](/12_process/12.c)
...
# [13_waiting](/13_waiting)
### • [Задача 13.1](/13_waiting/13_1.c)
...
# [15_signals](/15_signals)
### • [Задача 15.1](/15_signals/15_1.c)
